...
static void _out_rev(debug_printf_function_t *func, const char* buf, size_t len, uint32_t width, uint32_t flags) {
    size_t idx = 0;
...
static void _ntoa_format(debug_printf_function_t *func, char *buf, size_t len, bool negative, uint32_t base, uint32_t prec, uint32_t width, uint32_t flags) {
    // pad leading zeros
    if(!(flags & PRINT_FLAG_LEFT)) {
...
static void _ntoa_long(debug_printf_function_t *func, unsigned long value, bool negative, uint32_t base, uint32_t prec, uint32_t width, uint32_t flags) {
...
static void _ntoa_long_long(debug_printf_function_t *func, unsigned long long value, bool negative, uint32_t base, uint32_t prec, uint32_t width, uint32_t flags) {
    char buf[PRINTF_NTOA_BUFFER_SIZE];
    size_t len = 0;
...
int _vsnprintf_internal(debug_printf_function_t *func, const char *format, va_list args) {
...
void printf_write_char_str(debug_printf_function_t *func, char c) {
